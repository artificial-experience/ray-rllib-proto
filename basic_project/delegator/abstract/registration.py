...
class ConstructRegistry:
    ...
    def create(cls, construct_type, path_to_construct_file):
        ...
        if not hasattr(construct_class, 'from_construct_registry_directive'):
            raise TypeError(f"{construct_class.__name__} does not implement 'from_construct_registry_directive' class method")
        
        construct_registry_directive = {
            "path_to_construct_file": path_to_construct_file,
        }

        return construct_class.from_construct_registry_directive(construct_registry_directive)
