...
class TrainableConstructDelegator:
    ...
    def from_construct_directive(cls, construct_directive: dict):
        ...
        instance._registered_trainable_constructs = ConstructRegistry.get_registered_constructs()
        return instance
    ...
    def delegate(self):
        ...
        if self._target_trainable_construct in self._registered_trainable_constructs:
            ...
            raise SystemError(f"ERROR: {self._target_trainable_construct} is not registered")
        return construct
